...
const StoryCard = ({
  ...
  return (
    <div
      ...
      className="flex flex-col mb-[20px] w-[48%] md:w-[30%] lg:w-[15%] p-2 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl cursor-pointer"
    >
